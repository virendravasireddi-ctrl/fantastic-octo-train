...
This series runs **chronologically from Ancient India (Unit 0, files 00A–00H) through History (Units 1–3, files 01–15)**, then **Geography of India & AP (Unit 4, files 16–20)**, **Modern Andhra & the Nationalist Movement (Unit 5, files 21–26)** — Company rule to the bifurcation of 2 June 2014 — and closes with **British Rule in India & the National Movement (Unit 6, files 27–30)**, the Part-A modern-India half: EIC hegemony → land revenue & 1857 → reform movements → Gandhi-Bose-Patel-Ambedkar. For the **Public Administration** and **Economy** papers and the deep-dive essays, see [Companion material](#companion-material-other-series--essays) below.
