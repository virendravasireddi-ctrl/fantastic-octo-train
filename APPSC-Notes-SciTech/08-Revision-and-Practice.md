...
### 1.3 Nuclear ladder
**1956** Apsara · **1969** Tarapur · **1974** Pokhran-I · **1985** Dhruva · **1998** Pokhran-II (11 May) · **2008** Indo-US deal/NSG waiver · **2023** KAPP-3 (700 MW) · **2024** PFBR core-loading · **2025** Nuclear Energy Mission (₹20,000 cr, SMRs).

---

## 2. Quick match-the-following sets ⭐ (flashcard these)

**Policy ↔ year:** SPR-1958 · TPS-1983 · STP-2003 · STIP-2013 · draft STIP-2020.
**Mission ↔ outlay:** NQM ₹6,003.65 cr · IndiaAI ₹10,371.92 cr · ISM ₹76,000 cr · Green Hydrogen ₹19,744 cr · ANRF ₹50,000 cr · RDI ₹1,00,000 cr.
**Institute ↔ city:** BARC-Mumbai · IGCAR-Kalpakkam · VSSC-Thiruvananthapuram · SHAR-Sriharikota · URSC-Bengaluru · SAC-Ahmedabad · NRSC-Hyderabad · NSTL-Vizag · CTRI-Rajahmundry · NARL-Gadanki.
...
3. India's three-stage nuclear programme uses, in the final stage, mainly — (a) enriched uranium (b) plutonium (c) **thorium** (d) deuterium. **(c)**
4. The world's only reactor fuelled by U-233 is — (a) Dhruva (b) Apsara (c) **KAMINI** (d) PFBR. **(c)**
5. Chandrayaan-3 landed near the lunar — (a) equator (b) **south-pole region** (c) far side (d) Mare Imbrium. **(b)**
6. ANRF, operational 2024, subsumes — (a) DST (b) **SERB** (c) CSIR (d) UGC. **(b)**
7. Which is NOT part of the IGMDP (1983)? — (a) Prithvi (b) Agni (c) Akash (d) **BrahMos**. **(d)**
8. India's first indigenous COVID-19 vaccine was developed by — (a) SII (b) **Bharat Biotech (Covaxin)** (c) Zydus (d) Biocon. **(b)**
9. NavIC is a — (a) global system (b) **regional navigation system** (c) communication satellite (d) weather satellite. **(b)**
10. All Indian orbital launches take place from — (a) VSSC (b) **SDSC SHAR, Sriharikota** (c) URSC (d) Kulasekarapattinam. **(b)**
11. The Technology Policy Statement stressing self-reliance was issued in — (a) 1958 (b) **1983** (c) 2003 (d) 2013. **(b)**
12. TKDL famously helped revoke patents on — (a) tulsi & amla (b) **turmeric & neem** (c) ashwagandha (d) sandalwood. **(b)**
13. UPI is operated by — (a) RBI (b) SBI (c) **NPCI** (d) SEBI. **(c)**
14. INCOIS, which issues tsunami warnings, is headquartered at — (a) Chennai (b) **Hyderabad** (c) Goa (d) Vizag. **(b)**
15. The National Quantum Mission (2023) has an outlay of about — (a) ₹1,000 cr (b) **₹6,000 cr** (c) ₹10,000 cr (d) ₹76,000 cr. **(b)**
16. India's first indigenous CAR-T cell therapy is — (a) Rotavac (b) CERVAVAC (c) **NexCAR19** (d) iNCOVACC. **(c)**
17. The first indigenous aircraft carrier is — (a) INS Vikramaditya (b) **INS Vikrant** (c) INS Arihant (d) INS Vishal. **(b)**
...
3. **Role & scope of S&T in nation-building (AP perspective)** — File 05 §3 table + AP box + Kalam.
4. **India's contribution to space & its societal applications** — File 03 §1; capability→application→credibility.
5. **India's nuclear programme and energy security** — three stages + 700-MW fleet + Nuclear Energy Mission 2025.
6. **Indigenous technology & Atmanirbhar Bharat** — File 07 §3; marquee list + import-dependence balance.
7. **Digital Public Infrastructure as India's gift to the world** — Aadhaar-UPI-India Stack + G20 2023 + digital-divide caveat.
...
## 5. Andhra Pradesh capsule (last-mile) ⭐
- **Space:** SDSC SHAR, Sriharikota (3rd pad sanctioned 2025); NARL Gadanki (atmosphere).
- **Defence/marine:** NSTL, Hindustan Shipyard, Eastern Naval Command, Naval Dockyard (Vizag); Nagayalanka test range.
- **Atomic:** Tummalapalle uranium (Kadapa); Kovvada NPP proposed (Srikakulam).
- **Agri/aqua:** ANGRAU (Guntur), CTRI (Rajahmundry), aqua-hatchery & PFZ tech — AP leads Blue Revolution (~30% fish/shrimp).
...
## 6. Numbers to keep fresh (re-verify in final week)
- **GERD ~0.64% of GDP** (target 2%); researchers **~260/million**; **GII 38 (2025)**.
- **~50% installed power capacity non-fossil (2025)**; nuclear ~8.2 GW → 22.5 GW (2031-32).
