...
| Industry | Core problems | Policy response |
|---|---|---|
| **Coal** | World's #2 producer yet imports ~240–260 MT (coking-coal gap ⭐); CIL near-monopoly; high-ash quality; rail evacuation bottlenecks | **Commercial mining auctions (2020)** ⭐; production crossed **1 billion tonnes FY25** ⭐; coal-gasification mission (100 MT by 2030) |
| **Crude oil** | Declining legacy fields (Bombay High); **import dependence ≈88%** ⭐ | **HELP 2016 / OALP** (revenue-share, open acreage); **ISPRL strategic reserves (5.33 MMT)**; ONGC **KG-DWN-98/2 first oil 2024 — off the AP (Godavari) coast** ⭐ |
| **Natural gas** | ~50% imported (LNG); pricing disputes; pipeline gaps | Kirit Parikh pricing reform (2023 ceiling); city-gas rounds; "gas-based economy" 15%-share target |
| **Refinery products** | Crude import bill; carbon exposure | Capacity ≈ **257 MT → ~310 MT planned**; petro-products a top export earner; **HPCL Visakh expansion to 15 MTPA** (AP tie-in ⭐) |
...
5. **Global exposure:** commodity cycles, dumping, and now **carbon border taxes (EU CBAM from 2026)** ⭐ hitting steel/cement/aluminium exports.
6. **Monopoly legacies** (CIL) and incomplete markets (gas, power exchanges deepening only now).
...
1. **ICI: 8 industries, 40.27% of IIP, base 2011-12**; heaviest **refinery products (28.04)**, lightest **fertilisers (2.63)** ⭐.
2. Order: **R > E > S > C > C > NG > C > F** — Refinery, Electricity, Steel, Coal, Crude, Nat-gas, Cement, Fertilisers.
3. Coal output crossed **1 bn tonnes (FY25)**; commercial mining auctions since **2020**.
4. Crude import dependence ≈ **88%**; gas ≈ 50%; **HELP/OALP 2016**; ISPRL **5.33 MMT**.
5. **NSP 2017: 300 MT steel capacity by 2030-31**; safeguard duty **12% (2025)**; per-capita steel ≈ **98 kg**.
6. **NBS 2010 excludes urea** ⭐; nano urea — **IFFCO 2021**; ONOF 2022 ("Bharat" brand).
7. **UDAY 2015; RDSS 2021 (₹3.03 lakh cr)**; AT&C ≈ 15–17%.
8. **KG-DWN-98/2 first oil 2024** (ONGC, deepwater, AP offshore) ⭐.
9. **EU CBAM transitional now, definitive from 2026** — steel/cement/aluminium exposure.
10. AP: **no coal post-bifurcation (Singareni → Telangana)**; HPCL Visakh **15 MTPA**; Coromandel Kakinada (phosphatics).
