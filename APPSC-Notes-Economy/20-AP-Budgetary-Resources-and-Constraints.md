...
AP RECEIPTS
├── REVENUE RECEIPTS
│   ├── Own Tax Revenue ≈₹1.09 lakh cr (≈6% of GSDP)
│   │   ├── SGST — largest head (≈37% of OTR) ⭐
│   │   ├── State excise (liquor)
│   │   ├── Sales tax/VAT on petro-fuels & liquor (outside GST)
│   │   ├── Stamps & registration
│   │   └── Motor-vehicle tax; electricity duty
│   ├── Own Non-Tax Revenue (small) — mining royalties, sand,
│   │   forest, interest/dividends, user charges
│   └── Central transfers
│       ├── Tax devolution — AP's inter-se share ≈4.05% (15th FC) ⭐
│       └── Grants: post-devolution REVENUE-DEFICIT grants
...
## 1. Budgetary resources — the six real sources ⭐

| Source | AP specifics | Health |
|---|---|---|
...
1. **SGST = largest own-tax head (~37% of OTR, BE 2025-26)**; own-tax/GSDP ≈6%.
2. AP's **15th FC devolution share ≈4.05%** (was ≈4.3% under 14th FC); AP receives **post-devolution revenue-deficit grants (≈₹30,497 cr, 2021-26)** ⭐.
3. **GST compensation to states ended June 2022**.
4. Liquor: **phased prohibition 2019-24 (state retail monopoly) → 2024 policy restored private retail**.
5. **Land Pooling Scheme, Amaravati ≈34,000 acres** — non-debt resource mobilization ⭐.
6. Net borrowing ceiling **≈3% of GSDP + 0.5% power-reform add-on**; Art. 293(3) consent.
7. **P4 = Public-Private-People Partnership** (Zero-Poverty programme); **Swarnandhra Vision 2047** growth target ≈15%.
8. Petroleum fuels & liquor remain **outside GST** — AP's flexible tax handles.
