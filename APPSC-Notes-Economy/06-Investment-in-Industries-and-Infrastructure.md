...
## 0. The investment picture

- **GFCF (investment rate) ≈30–31% of GDP**; gross savings ≈30% — India mostly self-finances, with a modest current-account gap.
- Post-2010s problem: **private corporate capex stayed shy** (twin-balance-sheet hangover, demand uncertainty) → the state led with **public capex (₹11.2 lakh crore BE FY26; ~3.1% of GDP; "effective capex" ≈₹15.5 lakh crore incl. grants for capital assets)** betting on **crowding-in** ⭐.
- Household investment tilts to real estate/gold; **net financial savings ≈5% of GDP (FY23 dip)** — the mobilization constraint recurs.

## 1. Industrial investment — the policy arc

- **1991 New Industrial Policy:** de-licensing, MRTP defanged, FDI opened — investment decisions moved to markets.
- **Make in India (2014)**; **manufacturing stuck ≈17% of GVA** — the gap the next instruments attack:
  - **PLI schemes (2020–): 14 sectors, ≈₹1.97 lakh crore** ⭐ — output/sales-linked subsidies; star result: **mobile phones — India now a top exporter (Apple ecosystem)**; mixed elsewhere.
...
| Channel | Mechanics | Markers |
|---|---|---|
| **Budgetary support** | Direct capex/grants | Centre ₹11.2 lakh cr (FY26); states' capex + 50-yr interest-free loans |
| **IEBR** ⭐ | PSU internal accruals + their own bonds/loans (off the fiscal deficit) | NTPC/NHAI/IRFC bonds |
| **PPP models** | **BOT-Toll / BOT-Annuity / EPC** (govt pays, no private traffic risk) / **HAM (2016): 40% construction grant + 60% annuity** ⭐ / **TOT (2016): monetise operating roads** / DBFOT | Kelkar Committee (2015) on PPP revival |
...
1. **Twin balance sheet (Economic Survey 2016-17)** — over-leveraged corporates + NPA banks → froze private capex; resolved via IBC/recap (but "**bank-led infra finance = ALM mismatch**" remains structural — hence bonds/DFIs).
2. **Land acquisition & clearances** (2013 Act's cost-time), litigation, stalled projects; **appraisal optimism** and renegotiation culture in PPPs (why HAM replaced pure BOT).
3. **User-charge politics** (tolls, tariffs, farm power) → revenue-risk aversion.
4. **State capacity & contract enforcement** — dispute-resolution reform (conciliation, arbitration backlog).
5. **Crowding-in question**: public capex has led; the private cycle must follow (capacity-utilisation, profits are supportive — track it).

## 5. AP projects box ⭐⭐ (localise every answer)
...
1. **GFCF ≈30–31% of GDP**; Centre capex **₹11.2 lakh cr (BE FY26)**; effective capex ≈₹15.5 lakh cr.
2. **PLI: 14 sectors, ≈₹1.97 lakh crore (2020–)**; ISM 2021 **₹76,000 cr**; first Made-in-India chips **2025**.
3. **12 industrial smart cities (2024)** — AP: **Orvakal (Kurnool), Kopparthy (YSR Kadapa)** ⭐.
4. **NIP 2019 — ₹111 lakh crore**; **Gati Shakti 2021**; NLP 2022.
5. **HAM = 40:60 (2016); TOT 2016; VGF 2006 (20%+20%)**; Kelkar Committee 2015 (PPP).
6. **NMP-1 ₹6 lakh cr (FY22–25, ≈₹5.6 achieved); NMP-2.0 ₹10 lakh cr (2025–30)**.
7. **InvIT/REIT — SEBI 2014**; first REIT **Embassy 2019**; PowerGrid InvIT 2021.
8. **Twin balance sheet — Economic Survey 2016-17**; resolved via **IBC 2016** + recap.
9. IEBR = PSU internal & extra-budgetary resources (outside FD).
10. **VCIC — ADB**; Amaravati — **WB+ADB ≈$1.6 bn**; AP greenfield ports: **Ramayapatnam, Machilipatnam, Mulapeta**.
11. Kelkar (PPP 2015) vs Chakraborty (NIP task force 2019) — don't swap.
12. Municipal bonds — SEBI framework **2015**.

## 7. Mains angles

1. **"Public capex is necessary but not sufficient." Examine India's investment strategy since COVID.** Capex tripling + multiplier → crowding-in evidence/limits → private-capex conditions (demand, deleveraged banks, policy stability) → financing sustainability (debt anchor).
2. **Evaluate PPPs in Indian infrastructure.** BOT boom → renegotiation/NPA bust → Kelkar diagnosis → HAM/TOT/InvIT redesign (risk allocation!) → what still needs fixing (dispute resolution, user charges).
