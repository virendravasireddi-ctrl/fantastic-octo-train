...
### 1.1 Delivered (cite these as "done")
...
| Promise | Status |
|---|---|
| **Special Category Status (SCS)** | **Never in the Act** — a **PM's floor assurance in the Rajya Sabha (Feb 2014, 5 years)**, endorsed by the incoming NDA. 14th FC's framework was read as ending the SCS category for new entrants → Centre offered a **"Special Assistance Measure" (Sept 2016)** in lieu (repayment of external-loan dues on AP's EAPs). AP holds it a fraction of SCS's worth. **The defining AP-Centre conflict** ⭐ |
| **2014-15 "resource gap" (S.46)** | AP claimed **≈₹16,000 cr**; Centre released **≈₹4,100 cr** — standing demand of ~₹12,000 cr |
| **Kadapa steel plant** | Only "feasibility to be examined" in the Act; SAIL found it unviable; **five ground-breakings (2007-2023) and counting** — now pursued with private partners ✘ |
| **Dugarajapatnam port** | Declared **unfeasible**; AP built **Ramayapatnam** with state funds instead ✘ |
| **Greenfield crude refinery & petrochemicals complex** | BPCL feasibility stage; not sanctioned ✘ |
| **Vizag & Vijayawada-Guntur metro rail** | DPRs made (AMRC); **no central sanction yet** ✘ |

**The honest Mains line:** *institutions delivered, infrastructure part-delivered, fiscal promises contested* — the Act's "soft" promises (universities) were cheap and done; the "hard" ones (SCS, steel, refinery, resource gap) carried real money and stalled.
...
### 3.1 AP vs Centre
- **SCS denial** (above) — triggered TDP's 2018 NDA exit; still the touchstone of AP's "injustice" narrative.
- **Resource-gap arithmetic**; slow 13th-Schedule delivery; Polavaram **revised-cost disputes** (Centre long held funding to 2013-14 price level before the 2024 Phase-I package).

### 3.2 AP vs Telangana (the bifurcation residue)
| Dispute | Technical core |
|---|---|
...
1. **APRA 2014 = Act 6 of 2014; appointed day 2 June 2014**; Hyderabad common capital **ended 2 June 2024**.
2. **SCS was a Rajya Sabha assurance, NOT a provision of the Act** ⭐ (classic trap).
3. **S.90 — Polavaram national project, 100% central funding of irrigation component**; executed via **NABARD-LTIF**; Phase-I ₹12,157 cr (2024).
4. **S.93 + 13th Schedule** — institutions list; **S.94** — tax incentives & backward-district grants (7 districts).
5. **South Coast Railway zone, Visakhapatnam — operational 1 June 2026** ⭐.
6. **Dugarajapatnam dropped → Ramayapatnam (state-funded)**; Kadapa steel — feasibility only, 5 ground-breakings.
