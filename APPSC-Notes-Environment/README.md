# APPSC Notes — Environment, Ecology, Natural Resources & Sustainable Development

**Target exams:** APPSC Group-I (Mains — the **Environmental Geography / Ecology & Environment** portions of General Studies), and useful for Group-II and other state PSCs. Also a self-contained revision set for any **Environmental Studies (EVS)** paper covering natural resources, pollution, sustainable development, climate change and disaster management.

This series is **source-first and answer-oriented**: every file closes with **prelims nuggets**, **bolded match-pairs** for flashcards, and **Mains answer-skeletons**, with **Andhra Pradesh tie-ins** throughout (Mangampeta, Tummalapalle, KG basin, Kolleru, Polavaram, Red Sanders, Rayalaseema drought, Bay-of-Bengal cyclones, INCOIS-Hyderabad).
...
|---|---|---|
| [01-Development-vs-Environment-and-Types-of-Resources.md](01-Development-vs-Environment-and-Types-of-Resources.md) | Development-vs-nature debate; depletion & the tragedy of the commons; **metals/minerals conservation policy**; **types of natural resources (renewable vs non-renewable)**; conservation ethic & law/constitutional frame | ⭐⭐⭐ (the framing file) |
| [02-Forest-and-Fishery-Resources.md](02-Forest-and-Fishery-Resources.md) | **Forest resources** & ISFR 2023 data; deforestation/afforestation; **social forestry & JFM**; **fishery resources**, Blue Revolution, PMMSY; **AP = India's aqua-hub, Kolleru, Red Sanders** | ⭐⭐⭐ |
| [03-Fossil-Fuels-and-Mineral-Resources.md](03-Fossil-Fuels-and-Mineral-Resources.md) | **Coal, petroleum, natural gas**; **mineral resources**; MMDR policy arc & critical minerals; **mining in AP & India** (Mangampeta, Tummalapalle, KG basin, Black Galaxy, Samata judgment) | ⭐⭐⭐ (AP-core) |
| [04-Water-and-Land-Resources.md](04-Water-and-Land-Resources.md) | **Water resources — types & stress; watershed management** (PMKSY/Atal Bhujal/Neeru-Meeru); **land resources — soil types & soil reclamation** | ⭐⭐⭐ |
...
4. **Day 4 — File 04:** water stats + watershed ridge-to-valley + soil table + reclamation-by-problem; practise the "characterise AP soils" answer.
...
- **Prelims/Screening:** this subject is a *match-pair goldmine* — **law–year, treaty–purpose, mineral–district, soil–reclamant, disaster–agency, pollutant–disease**. Every such pair in these notes is **bolded** — turn them into flashcards.
- **Mains:** answers score when they (a) open with a **framing/thesis line** (development-vs-environment, sustainable-development, or hazard-vs-vulnerability), (b) give **2–3 specific facts** (a figure, a scheme, a location), and (c) close with an **Andhra Pradesh tie-in** (Mangampeta, Tummalapalle, KG basin, Kolleru, Polavaram, Rayalaseema drought, Bay-of-Bengal cyclones, INCOIS-Hyderabad, APPCB).
- **Data hygiene:** environment figures move every cycle — **re-verify** ISFR (forest cover), installed non-fossil capacity, fish-production rank, and COP outcomes from the latest official releases before the exam.
...
*Compiled July 2026. Cross-check against latest ISFR, IPCC, Economic Survey, MoEFCC/MoES and NITI Aayog SDG-Index editions before the exam.*
